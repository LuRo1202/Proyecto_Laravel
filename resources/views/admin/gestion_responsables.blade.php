...
<body>
        ...
        <div class="row">
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse show">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column px-3 mt-3">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="{{ route('admin.responsables.index') }}"><i class="bi bi-person-badge me-2"></i>Gestión Responsables</a></li>
                        {{-- Otros enlaces --}}
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Gestión de Responsables</h1>
                    <button class="btn btn-outline-secondary btn-sm" id="btnActualizarTabla">
                ...
                <div class="card">
                     <div class="card-header d-flex justify-content-between align-items-center">
                        <span><i class="bi bi-table me-2"></i>Lista de Responsables</span>
                        <button class="btn btn-light btn-sm" id="btnAgregarResponsable">
                            <i class="bi bi-plus-lg"></i> Agregar Responsable
                        </button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tablaResponsables" class="table table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Nombre</th><th>A. Paterno</th><th>A. Materno</th><th>Cargo</th><th>Departamento</th><th>Correo</th><th>Estado</th><th>Acciones</th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
                            </table>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalResponsableLabel">Agregar Responsable</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="formResponsable" novalidate>
                        <input type="hidden" id="responsable_id">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3"><label for="cargo" class="form-label">Cargo</label><input type="text" class="form-control" id="cargo"></div>
                            <div class="col-md-6 mb-3"><label for="departamento" class="form-label">Departamento</label><input type="text" class="form-control" id="departamento"></div>
                            ...
                            <div class="col-md-6 mb-3"><label for="contrasena" class="form-label">Contraseña</label><input type="password" class="form-control" id="contrasena"><small class="text-muted" id="passwordHelp">Dejar en blanco para no cambiar.</small></div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary" id="btnGuardarResponsable">Guardar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ asset('js/adminjs/gestion_responsables.js') }}"></script>
</body>
</html>