...
<body>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse show">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column px-3 mt-3">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="{{ route('admin.administradores.index') }}"><i class="bi bi-person-gear me-2"></i>Gestión Administradores</a></li>
                        {{-- Otros enlaces --}}
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="card">
                     <div class="card-header d-flex justify-content-between align-items-center">
                        <span><i class="bi bi-table me-2"></i>Lista de Administradores</span>
                        <button class="btn btn-light btn-sm" id="btnAgregarAdmin">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tablaAdministradores" class="table table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Nombre</th><th>A. Paterno</th><th>A. Materno</th><th>Correo</th><th>Último Login</th><th>Estado</th><th>Acciones</th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
                            </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAdminLabel">Agregar Administrador</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="formAdmin" novalidate>
                        <input type="hidden" id="admin_id">
                        <div class="mb-3"><label for="nombre" class="form-label">Nombre(s)*</label><input type="text" class="form-control" id="nombre" required></div>
                        <div class="row"><div class="col-md-6 mb-3"><label for="apellido_paterno" class="form-label">Apellido Paterno*</label><input type="text" class="form-control" id="apellido_paterno" required></div><div class="col-md-6 mb-3"><label for="apellido_materno" class="form-label">Apellido Materno</label><input type="text" class="form-control" id="apellido_materno"></div></div>
                        ...
                        <div class="mb-3"><label for="contrasena" class="form-label">Contraseña</label><input type="password" class="form-control" id="contrasena"><small class="text-muted" id="passwordHelp">Dejar en blanco para no cambiar.</small></div>
                    </form>
                </div>
    ...
    <script src="{{ asset('js/adminjs/gestion_administradores.js') }}"></script>
</body>
</html>